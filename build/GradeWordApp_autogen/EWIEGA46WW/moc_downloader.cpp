...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Downloader::*)(const QString & )>(_a, &Downloader::finished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Downloader::*)(const QString & )>(_a, &Downloader::error, 1))
            return;
    }
}
...
// SIGNAL 1
void Downloader::error(const QString & _t1)
{
